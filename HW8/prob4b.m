...
%Again solving for Molar amount using manual iteration (partially in excel) tested at 50,60,40,35,37.5(so lucky) and found 37.5 to be a reasonable solution
N=37.5
Tc = 1200
